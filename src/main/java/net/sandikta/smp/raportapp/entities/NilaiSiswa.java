...
import net.sandikta.smp.raportapp.entities.enums.DeskripsiBelajar;
...
public class NilaiSiswa {
	...
	public void setNamaMatpel(String mataPelajaran) {
	...
	public void setKkm(Integer nilaiKkm) {
		this.kkm = nilaiKkm;
	}
	...
	public void setKeterangan(Integer nilaiKkm) {
		if (this.nilaiAngka == 0) {
			this.keterangan = " ";
		}else if(this.nilaiAngka >= nilaiKkm) {
			this.keterangan = DeskripsiBelajar.TUNTAS.toString();
		} else if (this.nilaiAngka < nilaiKkm){
			this.keterangan = DeskripsiBelajar.BELUM_TUNTAS.toString();
		}
	}
}